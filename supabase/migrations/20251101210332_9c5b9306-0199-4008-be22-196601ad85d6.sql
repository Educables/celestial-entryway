-- Update the handle_new_user function to check for 'boss' prefix instead of 'admin'
...
DECLARE
  ...
  admin_count integer;
BEGIN
  -- Check if email starts with "boss" and count existing admins
  IF NEW.email ILIKE 'boss%' THEN
